...
Figure  shows the values of $\alpha$, by listing type. Most values are clustered around 1. Since most ratings are in the 4.8 - 5.0 range, this implies that, roughly, a 1% increase in a seller's rating is correlated with a roughly 5% increase in the price, a finding consistent with earlier literature. (citation) Unlike earlier literature, here the effect is strongly significant.

## Effect of rating on sales growth

Does the rating of a seller have an effect on sales growth? To construct sales growth, I use reviews as a proxy for sales.

...
prices_ = as.data.table(sqldf("SELECT p.dat AS dat,
                                      ...
                                      p.reviews_average_week AS reviews_average_week,
                                      p.reviews_average_month AS reviews_average_month,
                                      p.net_reviews AS net_reviews,
                                      p.net_reviews_smooth AS net_reviews_smooth,
                                      p.rowid AS id
                                FROM prices AS p
...
prices_$normalized[prices_$units == 'g'] = prices_$normalized[prices_$units == 'g']/1000
prices_$normalized[prices_$units == 'kg'] = prices_$normalized[prices_$units == 'kg']/1000000
prices_$normalized[prices_$units == 'ug'] = prices_$normalized[prices_$units == 'ug']*1000
prices_$normalized[prices_$units == 'oz'] = prices_$normalized[prices_$units == 'oz']/28349.5
prices_$normalized[prices_$units == 'lb'] = prices_$normalized[prices_$units == 'lb']/453592
prices_$log_normalized = log(prices_$normalized)
prices_ = prices_[prices_$units == 'mg' | prices_$units == 'g' | prices_$units == 'kg' | prices_$units == 'ug' | prices_$units == 'oz' | prices_$units == 'lb',]
```
...
pri = prices_[prices_$category == 2 & prices_$reviews_per_day > 0.1,]

summary(lm(pri$reviews_average_month ~ pri$rating))

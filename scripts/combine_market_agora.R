...
listings_$ships_from[listings_$ships_from == "us"] = "usa"
listings_$ships_from[listings_$ships_from == "thenetherlandsgermany"] = "netherlands"
listings_$ships_from[listings_$ships_from == "uk,usa,philippines"] = "world"
...
listings_$ships_from[listings_$ships_from == "uk,usaandworldwide"] = "world"
listings_$ships_from[listings_$ships_from == "uk,usa,eu,aus"] = "world"
listings_$ships_from[listings_$ships_from == "untiedkingdom"] = "uk"
listings_$ships_from[listings_$ships_from == "usa,ukandphilippines"] = "world"
...
listings_$ships_from[listings_$ships_from == "uk,usaworldwide"] = "world"
listings_$ships_from[listings_$ships_from == "ukandireland"] = "uk"
listings_$ships_from[listings_$ships_from == "usa,ukandworldwide"] = "world"
...
listings_$ships_from[listings_$ships_from == "dominicanrepublic"] = "southamerica"
listings_$ships_from[listings_$ships_from == "chile"] = "southamerica"
...
listings_$ships_from[listings_$ships_from == "pakistan"] = "asia"
listings_$ships_from[listings_$ships_from == "cambodia"] = "asia"
listings_$ships_from[listings_$ships_from == "malaysia"] = "asia"
listings_$ships_from[listings_$ships_from == "uk,asia"] = "uk"
listings_$ships_from[listings_$ships_from == "srilanka"] = "asia"
listings_$ships_from[listings_$ships_from == "japan"] = "asia"
listings_$ships_from[listings_$ships_from == "thailand"] = "asia"
listings_$ships_from[listings_$ships_from == "sweden"] = "europe"
listings_$ships_from[listings_$ships_from == "belgium"] = "europe"
listings_$ships_from[listings_$ships_from == "france"] = "europe"
listings_$ships_from[listings_$ships_from == "poland"] = "europe"
listings_$ships_from[listings_$ships_from == "ukraine"] = "europe"
listings_$ships_from[listings_$ships_from == "italy"] = "europe"
listings_$ships_from[listings_$ships_from == "austria"] = "europe"
listings_$ships_from[listings_$ships_from == "spain"] = "europe"
listings_$ships_from[listings_$ships_from == "switzerland"] = "europe"
listings_$ships_from[listings_$ships_from == "ireland"] = "europe"
listings_$ships_from[listings_$ships_from == "norway"] = "europe"
listings_$ships_from[listings_$ships_from == "latvia"] = "europe"
listings_$ships_from[listings_$ships_from == "scandinavia"] = "europe"
listings_$ships_from[listings_$ships_from == "slovakia"] = "europe"
listings_$ships_from[listings_$ships_from == "czechrepublic"] = "europe"
listings_$ships_from[listings_$ships_from == "denmark"] = "europe"
listings_$ships_from[listings_$ships_from == "finland"] = "europe"
listings_$ships_from[listings_$ships_from == "romania"] = "europe"
listings_$ships_from[listings_$ships_from == "germany"] = "europe"
listings_$ships_from[listings_$ships_from == "belarus"] = "europe"
listings_$ships_from[listings_$ships_from == "hungary"] = "europe"
listings_$ships_from[listings_$ships_from == "serbia"] = "europe"
listings_$ships_from[listings_$ships_from == "romania"] = "europe"
listings_$ships_from[listings_$ships_from == "eu"] = "europe"
listings_$ships_from[listings_$ships_from == "fiji"] = "other"
listings_$ships_from[listings_$ships_from == "singapore"] = "asia"
listings_$ships_from[listings_$ships_from == "bangkok"] = "asia"
listings_$ships_from[listings_$ships_from == "seychelles"] = "asia"
listings_$ships_from[listings_$ships_from == "barbados"] = "asia"
listings_$ships_from[listings_$ships_from == "philippines"] = "asia"
listings_$ships_from[listings_$ships_from == "canada"] = "northamerica"
listings_$ships_from[listings_$ships_from == "mexico"] = "northamerica"
listings_$ships_from[listings_$ships_from == "jamaica"] = "northamerica"
listings_$ships_from[listings_$ships_from == "southafrica"] = "africa"
listings_$ships_from[listings_$ships_from == "swaziland"] = "africa"
listings_$ships_from[listings_$ships_from == "chinaoreu"] = "china"
listings_$ships_from[listings_$ships_from == "argentina"] = "southamerica"
...
reviews_ = as.data.table(sqldf("SELECT dat, vendor, listing, val, content, user_rating, rowid AS id, scraped_at FROM reviews GROUP BY dat, vendor, listing, val, content"))
...
#prices_temp$dat = floor(prices_temp$dat)
...
# Re-create prices
#prices_$dat = prices_$days
#prices_ = as.data.table(sqldf("SELECT p.dat,
#                                        p.listing,
#                                        q.max_sales,
#                                        q.min_sales,
#                                        q.price,
#                                        q.rating FROM prices_ AS p
...
if (dbDisconnect(db)) {
    cat('\n[combine_market_agora.R]: Successfully wrote to database.\n')
}
